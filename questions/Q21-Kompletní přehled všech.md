...
- **Renesance** → Shakespeare  
- **Klasicismus** → Molière  
- **Romantismus** → Mácha, Erben  
- **Realismus** → Gogol, Borovský  
- **20. století** → války, totalita, existencialismus  
...
Např.:
- Orwell → antiutopie → totalita  
- Hemingway → realismus → boj člověka  
- Mácha → romantismus → tragická láska  
...
# 📚 Přehled četby k maturitě

---

## 🏛️ 1. Světová a česká literatura do konce 18. století

### ✍️ Směr: renesance, klasicismus
- důraz na člověka, rozum, řád
- drama jako hlavní žánr
...
### ✍️ Směry:
- romantismus → city, příroda, tragédie  
- realismus → skutečný život, kritika společnosti  
...
#### Karel Jaromír Erben
- Kytice  
- **směr:** romantismus (s prvky folkloru)  
- **žánr:** balady  
...
## ⚙️ 3. Světová literatura 20. a 21. století
...
# 🧠 Co chtějí u maturity

## ✔️ Musíš umět:
- zařadit dílo:
  - do **století**
  - do **literárního směru**
  - do **žánru a druhu**
- znát:
  - **téma a hlavní myšlenku**
  - **stručný děj**
  - **hlavní postavy**
- poznat:
  - jazyk (např. metafory, ironie)
- říct:
  - **kontext (historie, autoři ve stejné době)**
